                                    ...
                                    <?php foreach ($masterBarang as $mb) : ?>
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <a href="<?= base_url('admin/deleteMasterBarang/' . $mb['kd_barang']) ?>" class="badge badge-danger delete-confirm" data-item="<?= $mb['kd_barang']; ?>"><i class="far fa-fw fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                        <?php $i++; ?>
                                    <?php endforeach; ?>
