                                    ...
                                    <?php foreach ($transaksiPenjualan as $tp) : ?>
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <a href="<?= base_url('admin/deleteTransaksiPenjualan/' . $tp['kd_penjualan']) ?>" class="badge badge-danger delete-confirm" data-item="<?= $tp['kd_penjualan']; ?>"><i class="far fa-fw fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                        <?php $i++; ?>
                                    <?php endforeach; ?>
