                                    ...
                                    <?php foreach ($masterPelanggan as $mp) : ?>
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <a href="<?= base_url('admin/deleteMasterPelanggan/' . $mp['kd_pelanggan']) ?>" class="badge badge-danger delete-confirm" data-item="<?= $mp['kd_pelanggan']; ?>"><i class="far fa-fw fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                        <?php $i++; ?>
                                    <?php endforeach; ?>
