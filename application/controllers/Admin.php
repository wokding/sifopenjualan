...
class Admin extends CI_Controller
{
    ...
    public function deactivateUser($id)
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-warning" role="alert">User has been deactivated!</div>');
        redirect('admin/usermanagement');
    }
    ...
    public function changeUserRole($id)
    {
        ...
        $this->db->update('user', ['role_id' => $role_id], ['id' => $id]);
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">User role has been updated!</div>');
        redirect('admin/usermanagement');
    }
